...
module.exports = {
    SESSION_ID: process.env.SESSION_ID || "DARK-SILENCE-MD~nEBXFZ6a#Nf7-d5RbeEvyen_QIG4Mi459r87xjW6-Rdq7xEPRAOQ",
    ...
    ALIVE_MSG: process.env.ALIVE_MSG || "HII DEAR IM ONLINE I'M DIlUシ︎ WHATSAPP BOT 😊♻️",
